...
function updatesample() {
	if (samplecanvas.getContext) {
		...
		console.log("updatesample cxt null!");
	}
}
...
if (oldbgr) document.getElementById("md_bg_r").value = oldbgr;
if (oldbgg) document.getElementById("md_bg_g").value = oldbgg;
if (oldbgb) document.getElementById("md_bg_b").value = oldbgb;
if (oldfgr) document.getElementById("md_fg_r").value = oldfgr;
if (oldfgg) document.getElementById("md_fg_g").value = oldfgg;
